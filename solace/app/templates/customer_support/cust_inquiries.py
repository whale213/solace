...
def replyinquiries():
    ...
    if request.method == 'POST':
        ...
        print(inquiries)
        return render_template('staff_inquiries_reply_page.html', inquiries=inquiries, form=form)
...
def faq_add():
    if request.method == 'POST':
        ...
        return render_template('staff_faq_add_page.html')
...
def chatbot():
    return render_template('cust_chatbot_page.html')
