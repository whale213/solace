...
staff_delete_inquiries = Blueprint('delete', __name__)
customer_faq = Blueprint('faq', __name__)
staff_add_faq = Blueprint('faq_add', __name__)
staff_delete_faq = Blueprint('faq_delete', __name__)
